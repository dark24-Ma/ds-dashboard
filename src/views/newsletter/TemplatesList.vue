          ...
          <template #body>
            <div class="p-6">
              ...
              <p class="mb-4 text-gray-600 dark:text-gray-400">
                Vous êtes sur le point d'envoyer le template "{{ selectedTemplate?.subject }}" à vos abonnés.
              </p>
              ...
              <div class="mb-4">
                ...
                <div class="flex items-center">
                  <input type="radio" id="select-subscribers" v-model="sendToAll" :value="false" class="mr-2">

            ...
            <div>
              <div class="mb-5 sm:mb-8">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                  Entrez vos identifiants de connexion pour commencer
                </p>
              </div>
              <div>
                ...
                <form @submit.prevent="handleSubmit">
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      <br>
                      <button
                        class="inline-flex w-full items-center justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10">
                ...
                <div class="mt-5">
                  <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                    ...
                    <router-link to="/signup"
                      class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Inscription</router-link>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              ...
              <p class="text-center text-gray-400 dark:text-white/60">
                Cours sur développement personnel prospérité financière
              </p>
            </div>
          </div>
        </div>
...
const handleSubmit = async () => {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    if (error.response && error.response.status === 401) {
      errorMessage.value = 'L\'email et le mot de passe sont incorrects.';
    } else {

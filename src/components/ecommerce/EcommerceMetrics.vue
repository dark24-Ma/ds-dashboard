<template>
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
    ...
    >
      ...
      <div class="flex items-end justify-between mt-5">
        ...
        >
          ...
          >
            <path
              v-if="metrics.customers.isPositive"
              fill-rule="evenodd"
              clip-rule="evenodd"
          ...
          {{ Math.abs(metrics.customers.growth).toFixed(2) }}%
        </span>
      </div>
    </div>
    ...
    >
      ...
      <div class="flex items-end justify-between mt-5">
        <div>
          <span class="text-sm text-gray-500 dark:text-gray-400">Souscriptions</span>
          <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">
        ...
        >
          ...
          {{ Math.abs(metrics.orders.growth).toFixed(2) }}%
        </span>
      </div>
    </div>
  </div>
...
import DashboardStatisticsService, { type EcommerceMetrics } from '../../services/DashboardStatisticsService';

const metrics = ref<EcommerceMetrics>({
...
const loadMetrics = async () => {
  try {
    metrics.value = await DashboardStatisticsService.getEcommerceMetrics();
  } catch (error) {
